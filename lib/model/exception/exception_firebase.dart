...
class FirebaseLettException extends AppException {
  ...
  factory FirebaseLettException.fromAuthException(FirebaseAuthException exception) {
    final errorMessages = {
    ...
    final errorMessage = errorMessages[exception.code] ?? 'An unknown error occurred.';
